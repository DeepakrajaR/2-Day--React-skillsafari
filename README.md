...
A 2 Day React Workshop is for both beginners and advanced JavaScript and React developers. React is a JavaScript library. In this 2 Day React workshop, you will learn React which is one of most popular user interface JavaScript libraries. React can do everything that JavaScript can do. React can be used to add interactivity to websites, to develop mobile apps, desktop applications, games. 
...
2. A computer
3. Internet
4. A browser (Preferably Chrome)
5. A code editor(Preferably Vs Code)
...
If you have the skills mentioned above, you will enjoy doing React. This workshop contains several topics with easy-to-understand explanations, real-world examples and many hands-on exercises.

This Workshop is designed for beginners and professionals who want to build a web application using React and JavaScript.
